...
import com.antourage.weaverlib.dev_settings.ConfigManager
...
import com.antourage.weaverlib.networking.ConnectionStateMonitor.Companion.internetStateLiveData
import com.antourage.weaverlib.networking.NetworkConnectionState
import com.antourage.weaverlib.networking.Resource
import com.antourage.weaverlib.networking.sockets.SocketConnector
import com.antourage.weaverlib.networking.sockets.SocketConnector.socketConnection
import com.antourage.weaverlib.networking.Status
...
import com.antourage.weaverlib.networking.PortalStateManager
...
class AntourageFab @JvmOverloads constructor(
    ...
    companion object {
        ...
        fun configure(context: Context, teamId: Int, localisation: String? = null) {
            Companion.localisation = initLocalisation(context, localisation)
            UserCache.getInstance(context)
            ConfigManager.init(context)
            Companion.teamId = ConfigManager.TEAM_ID ?: teamId
