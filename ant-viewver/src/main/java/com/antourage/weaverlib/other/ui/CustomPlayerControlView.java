...
public class CustomPlayerControlView extends FrameLayout {
    ...
    private final CustomPlayerControlView.ComponentListener componentListener;
    private final CopyOnWriteArrayList<CustomPlayerControlView.VisibilityListener> visibilityListeners;
    ...
    @Nullable private CustomPlayerControlView.ProgressUpdateListener progressUpdateListener;
    ...
    private OnPlayClickListener listener = null;
    ...
    public CustomPlayerControlView(
        ...
        componentListener = new CustomPlayerControlView.ComponentListener();
    ...
    /**
     * Adds a {@link com.google.android.exoplayer2.ui.PlayerControlView.VisibilityListener}.
     *
     * @param listener The listener to be notified about visibility changes.
     */
    public void addVisibilityListener(CustomPlayerControlView.VisibilityListener listener) {
        visibilityListeners.add(listener);
    }

    /**
     * Removes a {@link com.google.android.exoplayer2.ui.PlayerControlView.VisibilityListener}.
     *
    ...
    /**
     * Sets the {@link com.google.android.exoplayer2.ui.PlayerControlView.ProgressUpdateListener}.
     *
     * @param listener The listener to be notified about when progress is updated.
     */
    public void setProgressUpdateListener(@Nullable CustomPlayerControlView.ProgressUpdateListener listener) {
    ...
    public void show() {
        if (!isVisible()) {
            ...
            for (CustomPlayerControlView.VisibilityListener visibilityListener : visibilityListeners) {
    ...
    public void initOnPlayClickListener(OnPlayClickListener listener){
